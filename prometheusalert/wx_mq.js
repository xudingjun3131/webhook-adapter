...
exports.template = function(body) {
    ...
    var content = alerts.map(
        ...
        .concat(`###### 告警队列:<font color="comment">${alert.labels.queue}</font>`)
        .concat(`###### 告警集群:<font color="comment">${alert.labels.cluster}</font>`)
        .concat(`###### 告警策略:<font color="comment">${alert.labels.policy}</font>`)
